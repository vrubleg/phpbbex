...
/**
* Decode a UTF-8 string in specified encoding.
*
* @param	string	$string		Original string
* @param	string	$encoding	Desired encoding
* @return	string				The string, decoded in desired encoding
*/
function utf8_to($string, $encoding)
{
	$encoding = strtolower($encoding);
	return ($encoding == 'utf-8') ? $string : mb_convert_encoding($string, $encoding, 'utf-8');
}
...
function utf8_convert_message($message)
{
	...
	{
		$message = utf8_from($message, 'ISO-8859-1');
	}
