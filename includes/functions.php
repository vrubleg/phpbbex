...
function page_header($page_title = '', $display_online_list = true)
{
	...
	$template->assign_vars([
		...
		'T_STYLE_PATH'          => "{$web_path}styles/{$user->theme['template_dir']}",
		'T_SUPER_STYLE_PATH'    => ($user->theme['template_inherit_dir'] ?? false) ? "{$web_path}styles/{$user->theme['template_inherit_dir']}" : "{$web_path}styles/{$user->theme['template_dir']}",
		'T_TEMPLATE_PATH'       => "{$web_path}styles/{$user->theme['template_dir']}/template",
		'T_SUPER_TEMPLATE_PATH' => ($user->theme['template_inherit_dir'] ?? false) ? "{$web_path}styles/{$user->theme['template_inherit_dir']}/template" : "{$web_path}styles/{$user->theme['template_dir']}/template",
		'T_THEME_PATH'          => "{$web_path}styles/{$user->theme['theme_dir']}/theme",
		'T_IMAGESET_PATH'       => "{$web_path}styles/{$user->theme['imageset_dir']}/imageset",
		'T_IMAGESET_LANG_PATH'  => "{$web_path}styles/{$user->theme['imageset_dir']}/imageset/" . $user->lang_code,
		'T_IMAGES_PATH'         => "{$web_path}images/",
		'T_SMILIES_PATH'        => $web_path . SMILIES_PATH . '/',
		'T_TOPIC_ICONS_PATH'    => $web_path . TOPIC_ICONS_PATH . '/',
		'T_STYLESHEET_LINK'     => (!$user->theme['parse_css_file']) ? "{$web_path}styles/{$user->theme['theme_dir']}/theme/stylesheet.css" : append_sid(PHPBB_ROOT_PATH . 'style.php', 'id=' . $user->theme['style_id'] . '&amp;lang=' . $user->lang_code . '&amp;mtime=' . (int) @filemtime(PHPBB_ROOT_PATH . 'styles/' . $user->theme['theme_dir'] . '/theme/stylesheet.css')),
		'T_THEME_NAME'          => $user->theme['theme_dir'],
		'T_TEMPLATE_NAME'       => $user->theme['template_dir'],
		'T_SUPER_TEMPLATE_NAME' => ($user->theme['template_inherit_dir'] ?? false) ? $user->theme['template_inherit_dir'] : $user->theme['template_dir'],
