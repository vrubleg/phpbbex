...
class ucp_pm
{
	...
	{
		global $user, $template, $phpbb_root_path, $auth, $db, $config;
		...
		switch ($mode)
		{
			...
			case 'popup':
				...
				$template->assign_vars(array(
					...
					'CLICK_TO_VIEW'		=> sprintf($user->lang['CLICK_VIEW_PRIVMSG'], '<a href="' . append_sid("{$phpbb_root_path}ucp.php", 'i=pm&amp;folder=inbox') . '" onclick="jump_to_inbox(this.href); return false;">', '</a>'),
					'U_INBOX'			=> append_sid("{$phpbb_root_path}ucp.php", 'i=pm&amp;folder=inbox'),
					'UA_INBOX'			=> append_sid("{$phpbb_root_path}ucp.php", 'i=pm&folder=inbox', false))
				);
