	...
	*/
	function obtain_advanced_settings($mode, $sub)
	{
		...
		if ($data['script_path'] === '')
		{
			...
			$data['script_path'] = str_replace('\\', '/', trim(dirname($name)));
		}
		...
		while (($file = readdir($dir)) !== false)
		{
			...
			if (is_dir($path) && file_exists($path . '/iso.txt'))
			{
				...
				$valid_localized = array(
					'icon_back_top', 'icon_contact_aim', 'icon_contact_email', 'icon_contact_icq', 'icon_contact_jabber', 'icon_contact_skype', 'icon_contact_msnm', 'icon_contact_pm', 'icon_contact_yahoo', 'icon_contact_www', 'icon_post_delete', 'icon_post_edit', 'icon_post_info', 'icon_post_quote', 'icon_post_report', 'icon_user_online', 'icon_user_offline', 'icon_user_profile', 'icon_user_search', 'icon_user_warn', 'button_pm_forward', 'button_pm_new', 'button_pm_reply', 'button_topic_locked', 'button_topic_new', 'button_topic_reply',
				);
