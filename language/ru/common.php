...
$lang = array_merge($lang, [
	...
	'AVATAR_EMPTY_REMOTE_DATA'      => 'Не удалось загрузить указанный аватар. Возможно, данные повреждены или недопустимы.',
	'AVATAR_EMPTY_FILEUPLOAD'       => 'Загруженный файл аватара пуст.',
	'AVATAR_INVALID_FILENAME'       => '%s является недопустимым именем файла.',
	'AVATAR_NOT_UPLOADED'           => 'Загрузка аватара не удалась.',
	...
	'AVATAR_PHP_SIZE_NA'            => 'Слишком большой размер файла аватара.<br />Не удалось определить максимальный размер, установленный в php.ini.',
	...
	'AVATAR_REMOTE_UPLOAD_TIMEOUT'  => 'Аватар не может быть загружен из-за превышения времени ожидания ответа сервера на запрос.',
	'AVATAR_URL_INVALID'            => 'Указанный адрес аватара недопустим.',
	'AVATAR_URL_NOT_FOUND'          => 'Указанный файл аватара не найден.',
	'AVATAR_WRONG_FILESIZE'         => 'Размер файла аватара должен находиться в диапазоне от 0 до %1$d %2$s.',
	'AVATAR_WRONG_SIZE'             => 'Размеры отправленного аватара — %5$d×%6$d. Размеры аватара должны быть не менее %1$d×%2$d, но не более %3$d×%4$d. Все размеры указаны в пикселях.',
	...
	'LOGIN_ERROR_PASSWORD_RESET_REQUIRED' => 'Перед входом вам необходимо восстановить пароль через email. Вы можете %sзапросить новый пароль%s. Если проблема останется, свяжитесь с %sадминистратором%s.',
	...
	'TOO_LONG_ABOUT'                => 'Слишком длинный текст «О себе».',
	...
	'TOO_SHORT_ABOUT'               => 'Слишком короткий текст «О себе».',
	...
	'D_DAYS'                    => ['день', 'дня', 'дней'],
	'D_MONTHS'                  => ['месяц', 'месяца', 'месяцев'],
	'D_YEARS'                   => ['год', 'года', 'лет'],
