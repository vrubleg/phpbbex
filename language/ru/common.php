...
$lang = array_merge($lang, array(
	...
	'REMOVE'					=> 'Удалить',
	'REMOVE_INSTALL'			=> 'Пожалуйста, удалите, переместите или переименуйте каталог install, прежде чем начнёте пользоваться форумом. В противном случае будет доступен только панель администратора.',
	'REPLIES'					=> 'Ответы',
