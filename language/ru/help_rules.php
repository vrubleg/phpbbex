...
$help = array(
	...
	array(
		0 => '1.2. Общие правила',
		1 => 'Запрещены: <ol><li>грубые и нецензурные слова или выражения;</li><li>реклама;</li><li>порнография;</li><li>публикация чужой личной информации;</li><li>оскорбления, угрозы, клевета;</li><li>объекты расистского характера и разжигания межнациональной розни;</li><li>пропаганда античеловечных идей и идеологий (фашизм, нацизм, ксенофобия, гомофобия, антисемитизм и т.д.);</li><li>политическая, религиозная и иная пропаганда;</li><li>призывы к насилию или нарушению действующего законодательства.</li></ol>'
	),
	array(
		0 => '--',
