...
$lang = array_merge($lang, [
	...
	'FULL_FOLDER_REMOVED_MESSAGE'  => 'Одно старое личное сообщение было удалено, поскольку папка заполнена.',
	'FULL_FOLDER_REMOVED_MESSAGES' => 'Старых личных сообщений удалено из-за заполнения папки: %d.',
	...
	'RELEASE_MESSAGES'                  => '%sДобавить все отложенные сообщения во входящие%s… если в папке достаточно места',
	...
	'UCP_PM_OPTIONS'            => 'Папки и настройки',
