...
$lang = array_merge($lang, [
	...
	'FOES_EXPLAIN'              => 'Недруги — это пользователи, которые будут игнорироваться по умолчанию. Сообщения этих пользователей будут скрыты, и они не смогут отправлять вам личные сообщения. Учтите, что вы не можете игнорировать модераторов или администраторов.',
	...
	'SENT_AT'                   => 'Отправлено',
	'SHOW_EMAIL'                => 'Показывать адрес email',
