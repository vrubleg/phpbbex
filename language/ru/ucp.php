...
$lang = array_merge($lang, [
	...
	'UCP_ADMIN_ACTIVATE'		=> 'Укажите корректный адрес email. Администратор проверит вашу учётную запись и отправит на указанный адрес письмо, содержащее ссылку для активации учётной записи.',
	'UCP_ATTACHMENTS'			=> 'Вложения',
	'UCP_EMAIL_ACTIVATE'		=> 'Укажите корректный адрес email. На указанный вами адрес придёт письмо, содержащее ссылку для активации учётной записи.',
