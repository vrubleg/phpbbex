...
$lang = array_merge($lang, array(
	...
	'USERNAME_ALPHA_ONLY_EXPLAIN'	=> 'Должно быть от %1$d до %2$d знаков и должно содержать только буквы.',
	'USERNAME_ALPHA_SPACERS_EXPLAIN'=> 'Должно быть от %1$d до %2$d знаков и должно содержать только буквы, пробел или символы -._',
	'USERNAME_ASCII_EXPLAIN'		=> 'Должно быть от %1$d до %2$d знаков и должно содержать только символы ASCII, без специальных символов.',
	'USERNAME_LETTER_NUM_EXPLAIN'	=> 'Должно быть от %1$d до %2$d знаков и должно содержать только буквы или цифры.',
	'USERNAME_LETTER_NUM_SPACERS_EXPLAIN'=> 'Должно быть от %1$d до %2$d знаков и должно содержать только буквы, цифры, пробел или символы -._',
	'USERNAME_CHARS_ANY_EXPLAIN'	=> 'Должно быть от %1$d и до %2$d знаков.',
