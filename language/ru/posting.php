...
$lang = array_merge($lang, [
	...
	'ATTACH_UNALLOWED_EXT'		=> 'Недопустимое расширение файла. Попробуйте заархивировать файл в zip или 7z.',
	'ATTACH_IS_TOO_BIG'			=> 'Слишком большой файл. Допустимый размер файлов этого типа: ',
	...
	'BBCODE_F_HELP'				=> 'Размер шрифта: [size=85]текст[/size]',
	'BBCODE_IS_OFF'				=> '%sBBCode%s <em>ВЫКЛЮЧЕН</em>',
	'BBCODE_IS_ON'				=> '%sBBCode%s <em>ВКЛЮЧЁН</em>',
	'BBCODE_I_HELP'				=> 'Наклонный текст: [i]текст[/i]',
	'BBCODE_L_HELP'				=> 'Список: [list][*]список[/list] или [list=1][*]список[/list] (держите ctrl для ввода стартового значения нумерованного списка)',
	'BBCODE_LISTITEM_HELP'		=> 'Элемент списка: [*] (выделите текст для автоматической вставки в каждую строку)',
	...
	'BBCODE_Q_HELP'				=> 'Цитата: [quote]текст[/quote] или [quote=&quot;имя&quot;]текст[/quote] (держите ctrl для ввода имени цитируемого)',
	'BBCODE_S_HELP'				=> 'Цвет шрифта: [color=red]текст[/color] или [color=#FF0000]текст[/color]',
	'BBCODE_SPOILER_HELP'		=> 'Скрытый текст: [spoiler]текст[/spoiler] или [spoiler=&quot;заголовок&quot;]текст[/spoiler] (держите ctrl для ввода заголовка)',
	...
	'BBCODE_W_HELP'				=> 'Вставить ссылку: [url]http://url[/url] или [url=http://url]текст[/url]',
	...
	'CANNOT_POST_STICKY'		=> 'Вы не можете создавать закреплённые темы.',
	...
	'LOGIN_EXPLAIN_BUMP'		=> 'Авторизуйтесь для поднятия темы в этом разделе',
	'LOGIN_EXPLAIN_DELETE'		=> 'Авторизуйтесь для удаления сообщений в этом разделе',
	'LOGIN_EXPLAIN_EDIT'		=> 'Авторизуйтесь для редактирования сообщений в этом разделе',
	'LOGIN_EXPLAIN_POST'		=> 'Авторизуйтесь для создания сообщений в этом разделе',
	'LOGIN_EXPLAIN_QUOTE'		=> 'Авторизуйтесь для цитирования сообщений в этом разделе',
	'LOGIN_EXPLAIN_REPLY'		=> 'Авторизуйтесь, чтобы отвечать в темах в этом разделе',
	...
	'POLL_OPTIONS_EDIT_EXPLAIN'	=> 'Разместите каждый вариант ответа в новой строке. Максимальное количество вариантов: <strong>%d</strong>. При удалении вариантов ответа вы должны обнулить результаты опроса.',
	...
	'QUOTE_DEPTH_EXCEEDED'		=> 'Максимально допустимое количество вложенных друг в друга цитат: %1$d.',
	'SPOILER_DEPTH_EXCEEDED'	=> 'Максимально допустимое количество вложенных друг в друга спойлеров: %1$d.',
	...
	'STICKY_ANNOUNCE_TIME_LIMIT'=> 'Срок для объявления/закреплённой темы',
	...
	'USER_CANNOT_FORUM_POST'	=> 'Вы не можете размещать сообщения в этом разделе. Тип раздела не поддерживает этого.',
	...
	'WRONG_SIZE'				=> 'Размеры изображения должны быть не менее %1$d×%2$d и не более %3$d×%4$d. Размер отправленного изображения — %5$d×%6$d. Все размеры указаны в пикселях.',
