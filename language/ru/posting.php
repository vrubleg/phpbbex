...
$lang = array_merge($lang, array(
	...
	'BBCODE_L_HELP'				=> 'Список: [list]text[/list] или [list=1]text[/list] (нумерованный)',
	'BBCODE_LISTITEM_HELP'		=> 'Элемент списка: [*]text (выделите текст для автоматической вставки в каждую строку)',
