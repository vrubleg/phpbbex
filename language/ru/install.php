...
$lang = array_merge($lang, array(
	...
	'CONV_ERROR_REPLACE_CATEGORY'		=> 'Не удалось добавить новый раздел вместо старой категории.',
	'CONV_ERROR_REPLACE_FORUM'			=> 'Не удалось добавить новый раздел вместо старого раздела.',
	...
	<ul>
		...
		<li><a target="_blank" href="//phpbbex.com/forum/viewforum.php?f=12">Бесплатная поддержка</a></li>
		<li><a target="_blank" href="//phpbbex.com/forum/viewtopic.php?t=7">Конвертация базы из phpBB 3 в phpBBex</a></li>
		<li><a target="_blank" href="//phpbbex.com/forum/feed.php?mode=topics">RSS с новостями проекта</a></li>
	</ul>',
	...
	'PHP_SUPPORTED_DB_EXPLAIN'		=> 'Ваша версия PHP должна поддерживать <strong>не менее одной</strong> из поддерживаемых баз данных. Если в списке не окажется поддерживаемых баз, то свяжитесь со своим провайдером или обратитесь к соответствующему разделу документации PHP.',
	'PHP_SAFE_MODE'					=> 'Безопасный режим (Safe mode)',
	'PHP_SETTINGS'					=> 'Версия и настройки PHP',
	'PHP_SETTINGS_EXPLAIN'			=> 'Для установки phpBBex <strong>требуется</strong> версия PHP не ниже 5.6. Если ниже написано <var>Безопасный режим (Safe mode)</var>, то PHP работает в этом режиме. Это наложит некоторые ограничения на удалённое администрирование и аналогичные функции.',
	...
	'PHP_VERSION_REQD'				=> 'Версия PHP ≥ 5.6',
	...
	'SUPPORT_BODY'				=> 'Полная поддержка предоставляется для последнего стабильного релиза phpBBex бесплатно. Она включает:</p><ul><li>установку</li><li>конфигурацию</li><li>технические вопросы</li><li>проблемы, связанные с потенциальными ошибками программного обеспечения</li><li>обновление версий — кандидатов на релиз (RC) до последней стабильной версии</li></ul><h2>Получение поддержки</h2><p><a href="//phpbbex.com/">Форум поддержки phpBBex</a><br /><a href="//phpbbex.com/forum/viewtopic.php?t=2">Первое знакомство</a><br /><a href="//phpbbex.com/forum/viewtopic.php?t=8">FAQ по phpBBex</a><br /><a href="//phpbbex.com/forum/viewtopic.php?t=7">Конвертация базы из phpBB 3 в phpBBex</a><br /><br />Чтобы быть в курсе последних новостей и релизов, вы можете подписаться на <a href="//phpbbex.com/forum/feed.php?mode=topics">нашу RSS</a>.<br /><br />',
	'SYNC_FORUMS'				=> 'Синхронизация разделов',
