...
$lang = array_merge($lang, array(
	...
	'INSTALL_CONGRATS_EXPLAIN'	=> '
		...
		<p>Нажав на кнопку ниже, вы попадёте в раздел администратора. Ознакомьтесь с имеющимися пунктами меню и настройками. Освоение имеющихся возможностей phpBBex может занять некоторое время. Помните о доступной в интернете <a href="http://www.phpbb.com/support/documentation/3.0/">документации на phpbb.com</a> (на английском) и <a href="http://phpbbex.com/">форуме русскоязычной поддержки phpBBex</a>.</p><p><strong>Удалите, переместите или переименуйте каталог «install» перед использованием конференции. В противном случае будет доступен только администраторский раздел.</strong>',
