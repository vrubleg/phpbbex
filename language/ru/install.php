...
$lang = array_merge($lang, array(
	...
	'CONV_ERROR_ATTACH_FTP_DIR'			=> 'На старой конференции включена загрузка вложений по FTP. Отключите эту функцию и убедитесь в правильности указанного каталога для загрузки, затем скопируйте все файлы вложений в этот новый каталог, доступный через интернет. После этого перезапустите конвертер.',
	...
	'FORUM_PATH_EXPLAIN'		=> '<strong>Относительный</strong> путь к старой конференции от <strong>корневого каталога установленного phpBBex</strong>.',
	'FOUND'						=> 'Найден',
	...
	'INST_ERR_DB_FORUM_PATH'	=> 'Указанный файл базы данных находится в каталоге конференции. Необходимо переместить его в каталог, недоступный из интернета.',
	...
	'PHP_SETTINGS_EXPLAIN'			=> 'Для установки phpBBex <strong>требуется</strong> версия PHP не ниже 5.2.3. Если ниже написано <var>Безопасный режим (Safe mode)</var>, то PHP работает в этом режиме. Это наложит некоторые ограничения на удалённое администрирование и аналогичные функции.',
	...
	'PHP_VERSION_REQD'				=> 'Версия PHP ≥ 5.2.3',
	...
	'SEARCH_INDEX_UNCONVERTED_EXPLAIN'	=> 'Ваш старый поисковый индекс не был сконвертирован. Любой поисковый запрос вернёт пустой результат. Чтобы создать новый поисковый индекс, перейдите в панель администратора, выберите раздел «Обслуживание» и в нём пункт «Поисковый индекс».',
	...
	'SUPPORT_BODY'				=> 'Полная поддержка предоставляется для последнего стабильного релиза phpBBex бесплатно. Она включает:</p><ul><li>установку</li><li>конфигурацию</li><li>технические вопросы</li><li>проблемы, связанные с потенциальными ошибками программного обеспечения</li><li>обновление версий — кандидатов на релиз (RC) до последней стабильной версии</li></ul><h2>Получение поддержки</h2><p><a href="http://phpbbex.com/">Форум поддержки phpBBex</a><br /><a href="http://phpbbex.com/forum/viewtopic.php?t=2">Первое знакомство</a><br /><a href="http://phpbbex.com/forum/viewtopic.php?t=8">FAQ по phpBBex</a><br /><a href="http://phpbbex.com/forum/viewtopic.php?t=7">Конвертация базы из phpBB 3 в phpBBex</a><br /><br />Чтобы быть в курсе последних новостей и релизов, вы можете подписаться на <a href="http://phpbbex.com/forum/feed.php?mode=topics">нашу RSS</a>.<br /><br />',
...
// Updater
$lang = array_merge($lang, array(
	'ALL_FILES_UP_TO_DATE'		=> 'Все файлы соответствуют самой последней версии phpBB. Теперь <a href="../ucp.php?mode=login">войдите на конференцию</a> и проверьте, что всё работает нормально. Не забудьте удалить, переименовать или переместить каталог «install»! Пожалуйста, отправьте нам обновлённую информацию о вашем сервере и конфигурации конференции с помощью страницы <a href="../ucp.php?mode=login&amp;redirect=adm/index.php%3Fi=send_statistics%26mode=send_statistics">Статистические данные</a> в панели администратора.',
	...
	'COMPLETE_LOGIN_TO_BOARD'		=> '<a href="../ucp.php?mode=login">Войдите на конференцию</a> и проверьте, что всё работает нормально. Не забудьте удалить, переименовать или переместить каталог install!',
	...
	'UPDATE_INSTRUCTIONS_INCOMPLETE'	=> '
		...
		<p>Обнаружено, что предыдущее автоматическое обновление не было завершено. Убедитесь в том, что все шаги автоматического обновления были выполнены. Перейдите по ссылке ниже или непосредственно в каталог установки.</p>
	',
...
$lang = array_merge($lang, array(
	...
	'DEFAULT_INSTALL_POST'			=> 'Это пример сообщения на вашей конференции phpBBex. Всё работает правильно. Вы можете удалить это сообщение и продолжить настройку вашей конференции. В процессе установки вашей первой категории и первому форуму были заданы подходящие права доступа для предустановленных групп администраторов, супермодераторов, гостей и зарегистрированных пользователей. Если вы решите удалить вашу первую категорию и первый форум, не забудьте установить права доступа для всех новых категорий и форумов, которые вы создаёте. Рекомендуем переименовать вашу первую категорию и первый форум и копировать права доступа с них вновь создаваемым категориям и форумам. Удачи!',
