...
$lang = array_merge($lang, array(
	...
	'INSTALL_INTRO'				=> 'Вас приветствует программа установки phpBBex',
	...
	<p>phpBBex поддерживает следующие базы данных:</p>
	<ul>
		<li>MySQL 5.0.3 и выше (поддерживается MySQLi)</li>
	</ul>
...
$lang = array_merge($lang, array(
	...
	'SMILE_HAND'					=> 'Привет!',
	'SMILE_REAL'					=> 'Улыбка',
	'SMILE_WINK'					=> 'Подмигивание',
	'SMILE_TWISTED'					=> 'Дьявольская улыбка',
	'SMILE_SAD'						=> 'Печальный',
	'SMILE_EVIL'					=> 'Очень злой',
	'SMILE_SMOKE'					=> 'Перекур',
	'SMILE_EH'						=> 'Чего?',
	'SMILE_BIGEEK'					=> 'Ничего себе!',
	'SMILE_FIE'						=> 'Фу...',
	'SMILE_SILENCED'				=> 'Молчу',
	'SMILE_TONGUE'					=> 'Показать язык',
	'SMILE_REDFACE'					=> 'Покраснел',
	'SMILE_HELP'					=> 'Помогите!',
	'SMILE_SPY'						=> 'Подозрительно',
	'SMILE_INSANE'					=> 'Не понимаю',
	'SMILE_BIGGRIN'					=> 'Огромная улыбка',
	'SMILE_TOOTHBIGGRIN'			=> 'Побитый',
	'SMILE_ILL'						=> 'Заболел',
	...
	'SMILE_NO'						=> 'Нет',
	'SMILE_YES'						=> 'Да',
	'SMILE_LOL'						=> 'Кататься по полу от смеха',
	'SMILE_CRANKY'					=> 'Ты что, того?',
	'SMILE_VERYMAD'					=> 'Злой',
	'SMILE_DANCE'					=> 'Танцую',
	'SMILE_DRUNK'					=> 'Выпивший',
	'SMILE_ANGEL'					=> 'Ангел',
	'SMILEHAND_SUPER'				=> 'Крутой',
	'SMILE_KETTLE'					=> 'Чайник',
