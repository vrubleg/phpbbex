...
$lang = array_merge($lang, [
	...
	'USER_ADMIN_AVATAR_REMOVED'		=> 'Аватар пользователя успешно удалён.',
	...
	'USER_AVATAR_NOT_ALLOWED'		=> 'Аватар не может быть отображён, поскольку аватары запрещены.',
	'USER_AVATAR_UPDATED'			=> 'Информация об аватаре пользователя успешно обновлена.',
	'USER_AVATAR_TYPE_NOT_ALLOWED'	=> 'Текущий аватар не может быть отображён, поскольку его тип запрещён.',
