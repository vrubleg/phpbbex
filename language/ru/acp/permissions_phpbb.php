...
$lang = array_merge($lang, [
	...
	'acl_u_masspm_nomax'=> ['lang' => 'Может игнорировать ограничение количества получателей ЛС', 'cat' => 'pm'],
...
$lang = array_merge($lang, [
	...
	'acl_a_search'      => ['lang' => 'Может управлять поисковым индексом/настройками поиска', 'cat' => 'misc'],
]);
