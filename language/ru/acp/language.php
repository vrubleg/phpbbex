...
$lang = array_merge($lang, [
	...
	'LANGUAGE_PACK_CODE'                => 'Код языка',
	'LANGUAGE_PACK_LOCAL_NAME'          => 'Локализованное название',
	'LANGUAGE_PACK_ENGLISH_NAME'        => 'Английское название',
	'LANGUAGE_PACK_NOT_EXIST'           => 'Выбранный языковой пакет не существует.',
	'LANGUAGE_PACK_USED_BY'             => 'Используют',

	'NO_LANG_CODE'                  => 'Вы не указали языковой пакет.',
