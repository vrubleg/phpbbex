...
$lang = array_merge($lang, array(
	'ACP_PERMISSIONS_EXPLAIN'	=> '
		...
		<p>Для получения более подробной информации по настройке и управлению правами доступа на вашей конференции phpBBex и phpBB 3 смотрите <a href="http://www.phpbb.com/support/documentation/3.0/quickstart/quick_permissions.html">руководство phpBB</a>.</p>
	',
	...
	'ROLE_DESCRIPTION_FORUM_FULL'			=> 'Доступ к использованию всех возможностей на форуме, включая создание объявлений и прилепленных тем. Также доступна возможность игнорирования флуд-интервала. Не рекомендуется для обычных пользователей.',
