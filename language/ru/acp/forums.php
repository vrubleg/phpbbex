...
$lang = array_merge($lang, array(
	...
	'FORUM_ADMIN_EXPLAIN'				=> 'phpBBex основан на форумах. Категория является особым типом форума. Каждый форум может иметь неограниченное количество подфорумов, и вы можете определять, разрешено в нём создавать темы или нет (в последнем случае форум будет действовать как категория в phpBB2). Здесь вы можете добавлять, редактировать, закрывать, открывать каждый из форумов, устанавливать некоторые дополнительные настройки. Если ваши сообщения и темы рассинхронизированы, вы можете также синхронизировать форум. <strong>Вы должны скопировать или установить нужные права для того, чтобы вновь созданный форум отображался в списке форумов.</strong>',
	...
	'FORUM_IMAGE_EXPLAIN'				=> 'Путь относительно корневого каталога phpBBex к дополнительному изображению, ассоциированному с этим форумом.',
