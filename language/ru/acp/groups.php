...
$lang = array_merge($lang, array(
	...
	'GROUP_EDIT_EXPLAIN'			=> 'Здесь можно изменить настройки существующей группы. Вы можете изменить название, описание и тип группы (открытая, закрытая и т. п.). Также можно установить некоторые дополнительные параметры, такие как цвет, звание и т. п. Текущие настройки пользователей будут заменены в соответствии с произведёнными здесь изменениями.',
