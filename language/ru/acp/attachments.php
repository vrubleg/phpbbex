...
$lang = array_merge($lang, [
	...
	'EXTENSION_INVALID'             => 'Расширение «%s» недопустимо. Разрешены только ASCII-буквы, цифры, дефис и подчёркивание (максимум 10).',
	...
	'NO_FILE_CAT'               => 'Нет',
	'NO_IMAGE'                  => 'Без иконки',
	'NO_THUMBNAIL_SUPPORT'      => 'Поддержка миниатюр отключена, поскольку PHP-расширение GD недоступно.',
	'NO_UPLOAD_DIR'             => 'Каталог для загрузки файлов не существует.',
	'NO_WRITE_UPLOAD'           => 'Каталог для загрузки файлов недоступен для записи. Измените права доступа для этого каталога, разрешив серверу запись в него.',
