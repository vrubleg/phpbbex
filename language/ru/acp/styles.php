...
$lang = array_merge($lang, array(
	...
	'IMAGESET_EXPORT_EXPLAIN'	=> 'Здесь вы можете экспортировать набор изображений в архив. Этот архив будет содержать все данные, необходимые для установки набора изображений на другой форум. Вы можете выбрать, скачивать ли файл напрямую или сохранить его в каталоге store, чтобы скачать его позднее через FTP.',
	...
	'IMG_FORUM_READ_SUBFORUM'	=> 'Подраздел',
	'IMG_FORUM_UNREAD'			=> 'Раздел с непрочитанными сообщениями',
	'IMG_FORUM_UNREAD_LOCKED'	=> 'Закрытый раздел с непрочитанными сообщениями',
	'IMG_FORUM_UNREAD_SUBFORUM'	=> 'Подраздел с непрочитанными сообщениями',
	'IMG_SUBFORUM_READ'			=> 'Легенда подраздела',
	'IMG_SUBFORUM_UNREAD'		=> 'Легенда подраздела с непрочитанными сообщениями',
	...
	'IMG_STICKY_READ'				=> 'Закреплённая тема',
	'IMG_STICKY_READ_MINE'			=> 'Закреплённая тема с моими сообщениями',
	'IMG_STICKY_READ_LOCKED'		=> 'Закрытая закреплённая тема',
	'IMG_STICKY_READ_LOCKED_MINE'	=> 'Закрытая закреплённая тема с моими сообщениями',
	'IMG_STICKY_UNREAD'				=> 'Закреплённая тема с непрочитанными сообщениями',
	'IMG_STICKY_UNREAD_MINE'		=> 'Закреплённая тема с непрочитанными сообщениями, содержащая мои сообщения',
	'IMG_STICKY_UNREAD_LOCKED'		=> 'Закрытая закреплённая тема с непрочитанными сообщениями',
	'IMG_STICKY_UNREAD_LOCKED_MINE'	=> 'Закрытая закреплённая тема с непрочитанными сообщениями, содержащая мои сообщения',
	...
	'TEMPLATE_CACHE_EXPLAIN'	=> 'По умолчанию phpBBex кэширует скомпилированную версию шаблонов. Это уменьшает нагрузку на сервер при каждом просмотре страниц и, таким образом, может снизить время их генерации. Здесь вы можете просмотреть статус кэша для каждого из файлов и удалить отдельные файлы или весь кэш.',
	...
	'TEMPLATE_EXPORT_EXPLAIN'	=> 'Здесь вы можете экспортировать шаблон в виде архива. Этот архив будет содержать все файлы, необходимые для установки шаблона на другой форум. Вы можете выбрать, скачивать ли файл напрямую или сохранить его в каталоге store, чтобы скачать его позднее через FTP.',
	...
	'TEMPLATE_FILE_NOT_WRITABLE'=> 'Не удалось записать файл шаблона %s. Проверьте права на каталоги и файлы.',
	...
	'THEME_EXPORT_EXPLAIN'		=> 'Здесь вы можете экспортировать тему в виде архива. Этот архив будет содержать все данные, необходимые для установки темы на другой форум. Вы можете выбрать, скачивать ли файл напрямую или сохранить его в каталоге store, чтобы скачать его позднее через FTP.',
