...
$lang = array_merge($lang, array(
	...
	'TEMPLATE_EXPORT_EXPLAIN'	=> 'Здесь вы можете экспортировать шаблон в виде архива. Этот архив будет содержать все файлы, необходимые для установки шаблона на другую конференцию. Вы можете выбрать, скачивать ли файл напрямую или сохранить его в каталоге store, чтобы скачать его позднее через FTP.',
	...
	'THEME_EXPORT_EXPLAIN'		=> 'Здесь вы можете экспортировать тему в виде архива. Этот архив будет содержать все данные, необходимые для установки темы на другую конференцию. Вы можете выбрать, скачивать ли файл напрямую или сохранить его в каталоге store, чтобы скачать его позднее через FTP.',
