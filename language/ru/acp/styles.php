...
$lang = array_merge($lang, [
	...
	'EDIT_TEMPLATE_EXPLAIN'				=> 'Здесь вы можете напрямую редактировать шаблон. Пожалуйста, не забывайте, что внесённые изменения окончательны и не могут быть отменены. PHP должен иметь возможность записи в файлы шаблона в каталоге стиля. Пожалуйста, будьте аккуратны, редактируя шаблон, не забывайте закрывать все переменные шаблона {XXXX} и условные операторы.',
