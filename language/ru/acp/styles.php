...
$lang = array_merge($lang, [
	...
	'CONFIRM_IMAGESET_REFRESH'		=> 'Вы действительно желаете обновить все данные набора изображений? Текущие данные набора изображений в базе данных будут заменены настройками из файла конфигурации набора изображений.',
