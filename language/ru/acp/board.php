...
$lang = array_merge($lang, [
	...
	'ALLOW_AVATAR_REMOTE'			=> 'Разрешить отображение аватаров по внешней ссылке',
	'ALLOW_AVATAR_REMOTE_EXPLAIN'	=> 'Не рекомендуется! Аватар будет отображаться напрямую с указанного адреса.',
