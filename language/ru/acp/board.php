...
$lang = array_merge($lang, [
	...
	'PM_MAX_RECIPIENTS_EXPLAIN' => 'Максимальное разрешённое количество получателей личного сообщения. 0 означает отсутствие ограничения.',
]);
...
$lang = array_merge($lang, [
	...
	'NEW_MEMBER_GROUP_DEFAULT_EXPLAIN'  => 'При включении данной опции и при указании лимита сообщений для новых пользователей, все новые пользователи будут не только входить в группу <em>Новые пользователи</em>, но эта группа также будет назначена им в качестве группы по умолчанию. Это может быть удобно, например, если вы хотите назначить на эту группу определённое звание.',
...
$lang = array_merge($lang, [
	...
	'CACHE_MTIME_CHECK'             => 'Автоматически обновлять устаревшие кэшированные данные',
	'CACHE_MTIME_CHECK_EXPLAIN'     => 'Проверка времени изменения исходных файлов и автоматическое обновление устаревших кэшированных или сгенерированных данных.',
...
$lang = array_merge($lang, [
	...
	'REFERER_VALID_EXPLAIN'         => 'Если включено, реферер для запросов типа POST будет проверен по хосту.',
