...
$lang = array_merge($lang, array(
	...
	'COOKIE_SECURE_EXPLAIN'		=> 'Если ваш сервер работает через SSL, то включите этот параметр. В противном случае оставьте выключенным. Включение этого параметра, если сервер работает не через SSL, приведёт к серьёзным ошибкам.',
	...
	'NO_SID'					=> 'Никогда не добавлять sid к ссылкам',
	'NO_SID_EXPLAIN'			=> 'Внимание! При неправильных настройках cookies и запрете sid вы не сможете авторизоваться.',
));
