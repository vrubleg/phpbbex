...
$lang = array_merge($lang, array(
	...
	'LOAD_USER_ACTIVITY_EXPLAIN'	=> 'Отображение темы/форума, в которых пользователь наиболее активен, в его профиле и панели управления. Рекомендуется отключить эту функцию на конференциях с более чем одним миллионом сообщений.',
