...
$lang = array_merge($lang, [
	...
	'ENABLE_READ_TRACKING'          => 'Включить непрочитанные темы',
	'ENABLE_READ_TRACKING_EXPLAIN'  => 'Сохранять в БД информацию о статусе «прочитано/не прочитано» для зарегистрированных пользователей. Если отключено, сообщения всегда помечены как прочитанные.',
	'AUTO_MARK_READ_DELAY'          => 'Помнить непрочитанные темы после последней активности',
	'AUTO_MARK_READ_DELAY_EXPLAIN'  => 'Непрочитанные темы будут автоматически отмечены прочитанными, если у пользователя не осталось сессий.',
...
$lang = array_merge($lang, [
	...
	'PM_MAX_RECIPIENTS_EXPLAIN' => 'Введите 1, чтобы запретить отправку нескольким пользователям, или 0, чтобы снять ограничение.',
]);
