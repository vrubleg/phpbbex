...
$lang = array_merge($lang, array(
	...
	'IMPORT_ALBUM'					=> 'Альбом для импорта фотографий',
	'IMPORT_DEBUG_MES'				=> '%1$s фотографий импортировано. Осталось %2$s.',
	'IMPORT_DIR_EMPTY'				=> 'Папка <em>%s</em> пуста. Загрузите в неё фотографии, и тогда сможете их импортировать.',
	'IMPORT_FINISHED'				=> 'Все фото (%1$s шт.) импортированы.',
	'IMPORT_FINISHED_ERRORS'		=> '%1$s фото импортировано, но произошли ошибки:<br /><br />',
	'IMPORT_MISSING_ALBUM'			=> 'Выберите альбом для импорта фотографий.',
	'IMPORT_SELECT'					=> 'Выберите фотографии для импорта. Удачно импортированные фото будут удалены из папки <em>gallery/images/import/</em>.',
	'IMPORT_SCHEMA_CREATED'			=> 'Схема импорта успешно создана. Ждите, пока фотографии будут импортированы.',
	'IMPORT_USER'					=> 'Кем загружено',
	'IMPORT_USER_EXP'				=> 'Можно загрузить фото от имени любого пользователя.',
	'IMPORT_USERS_PEGA'				=> 'Загрузить в личный альбом пользователя',
	...
	'NO_FILE_SELECTED'				=> 'Следует выбрать не менее одного файла.',
