...
$lang = array_merge($lang, [
	...
	'CACHE_DIR_SIZE'                => 'Размер кэша миниатюр',
	...
	'CLEAN_AUTHORS_DONE'            => 'Фотографии без владельцев удалены.',
	'CLEAN_CHANGED'                 => 'Автор изменен на «Гостя».',
	'CLEAN_COMMENTS_DONE'           => 'Комментарии без автора удалены.',
	...
	'CLEAN_NO_ACTION'               => 'Очистка не завершена. Что-то пошло не так.',
	'CLEAN_PERSONALS_DONE'          => 'Личные альбомы без владельца удалены.',
	'CLEAN_PERSONALS_BAD_DONE'      => 'Личные альбомы выбранных пользователей удалены.',
	'CLEAN_PRUNE_DONE'              => 'Очистка завершена.',
	'CLEAN_PRUNE_NO_PATTERN'        => 'Не задан шаблон поиска.',
	'CLEAN_SOURCES_DONE'            => 'Фотографии без файлов удалены.',
	...
	'CONFIRM_CLEAN_AUTHORS'         => 'Удалить фотографии без владельца?',
	'CONFIRM_CLEAN_COMMENTS'        => 'Удалить сообщения без владельца?',
	'CONFIRM_CLEAN_ENTRIES'         => 'Удалить файлы без записей в базе данных?',
	'CONFIRM_CLEAN_PERSONALS'       => 'Удалить личные альбомы без владельца?',
	'CONFIRM_CLEAN_PERSONALS_BAD'   => 'Удалить личные альбомы выбранных пользователей?<br /><strong>» %s</strong>',
	'CONFIRM_CLEAN_SOURCES'         => 'Удалить фотографии без файлов?',
	'CONFIRM_PRUNE'                 => 'Удалить фотографии, отвечающие следующим условиям:<br /><br />%s<br />',
	...
	'DISP_EXIF_DATA'                => 'Показывать данные EXIF',
	'DISP_EXIF_DATA_EXP'            => 'Эта опция недоступна в данный момент, потому что функция <em>exif_read_data</em> не включена в интерпретаторе PHP.',
	...
	'FEED_ENABLED_PEGAS'            => 'Включить каналы новостей для личных альбомов',
	...
	'GUPLOAD_DIR_SIZE'              => 'Размер загруженных изображений',
	...
	'PERMISSION_I_COUNT'            => 'Максимальное количество фото пользователя в альбоме',
	...
	'PERMISSION_I_UNLIMITED'        => 'Может игнорировать ограничение количества фото пользователя в альбоме',
	...
	'PRUNE'                         => 'Очистить',
	'PRUNE_ALBUMS'                  => 'Очистка альбомов',
	'PRUNE_CHECK_OPTION'            => 'Использовать эту опцию',
	'PRUNE_COMMENTS'                => 'Менее чем Х комментариев',
	'PRUNE_PATTERN_ALBUM_ID'        => 'Фотография находится в одном из этих альбомов:<br />&raquo; <strong>%s</strong>',
	'PRUNE_PATTERN_COMMENTS'        => 'У фотографии менее <strong>%d</strong> комментариев.',
	'PRUNE_PATTERN_RATES'           => 'Фотография оценена менее чем <strong>%d</strong> раз.',
	'PRUNE_PATTERN_RATE_AVG'        => 'Оценка фотографии ниже чем <strong>%s</strong>.',
	'PRUNE_PATTERN_TIME'            => 'Фотография загружена ранее чем <strong>%s</strong>.',
	'PRUNE_PATTERN_USER_ID'         => 'Фотография загружена одним из этих пользователей:<br />&raquo; <strong>%s</strong>',
	'PRUNE_RATINGS'                 => 'Оценено менее чем Х раз',
	'PRUNE_RATING_AVG'              => 'Общая оценка ниже чем',
	'PRUNE_RATING_AVG_EXP'          => 'Удалить фотографии с оценкой ниже чем <samp>X.YZ</samp>.',
	'PRUNE_TIME'                    => 'Загружено до даты',
	'PRUNE_TIME_EXP'                => 'Удалить фотографии, загруженные до <samp>YYYY-MM-DD</samp>.',
	'PRUNE_USERNAME'                => 'Автор',
	'PRUNE_USERNAME_EXP'            => 'Удалить фотографии, загруженные определёнными пользователями.',
	...
	'RESYNC_GALLERY_STATS'          => 'Синхронизировать статистику галереи',
	'RESYNC_GALLERY_STATS_CONFIRM'  => 'Подтвердите синхронизацию статистики галереи.',
	'RESYNC_GALLERY_STATS_EXPLAIN'  => 'Обновляет счётчики фото, данные личных альбомов, размеры файлов и сведения о последних фото.',
	'RESYNCED_GALLERY_STATS'        => 'Статистика галереи синхронизирована',
	...
	'RRC_PROFILE_MODE'              => 'Последние и случайные фото в профиле',
	'RRC_PROFILE_MODE_EXP'          => 'Случайные фото могут замедлить работу галереи.',
	'RRC_PROFILE_ROWS'              => 'Строки',

	'RSZ_HEIGHT'                    => 'Максимальная высота фото на странице просмотра',
	'RSZ_WIDTH'                     => 'Максимальная ширина фото на странице просмотра',
	...
	'UC_LINK_IMAGE'                 => 'Открыть полноразмерное фото',
	'UC_LINK_IMAGE_PAGE'            => 'Открыть страницу фотографии',
