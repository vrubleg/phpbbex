...
$lang = array_merge($lang, [
	...
	'MOVE_TO_PERSONAL_MOD'          => 'Если «Да», фото будет помещено в личный альбом пользователя.',
	'MOVE_TO_PERSONAL_EXPLAIN'      => 'Если «Да», фото будет помещено в ваш личный альбом.',
