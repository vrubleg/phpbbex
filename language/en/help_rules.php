...
$help = array(
	...
	array(
		0 => '1.2. General rules',
		1 => 'Do not publish information containing:<ol><li>advertising without prior approval from the administrator;</li><li>rude and obscene words or phrases;</li><li>pornography or shocking content;</li><li>someone else’s personal information;</li><li>insults, threats, slander;</li><li>objects of racism and incitement to ethnic strife;</li><li>propaganda of anti-human ideas and ideologies (fascism, nazism, xenophobia, homophobia, anti-semitism, etc.);</li><li>political, religious and other types of propaganda;</li><li>incitement to violence or breach of current legislation.</li></ol>'
	),
	array(
		0 => '--',
	...
	array(
		0 => '2.1. Registration',
		1 => 'Do not:<ol><li>specify a non-existent e-mail address;</li><li>create several accounts;</li><li>make false profiles of other users;</li><li>try to break other accounts by brute force.</li></ol>'
	),
	array(
		0 => '2.2. Username',
		1 => 'Do not:<ol><li>use usernames which can be similar to usernames of other members of the board;</li><li>use special characters in a username (which are neither letters nor numbers);</li><li>use usernames, almost entirely consisting of digits;</li><li>use website addresses as a username.</li></ol>'
	),
	array(
		0 => '2.3. Avatar',
		1 => 'Do not:<ol><li>use someone else’s avatar;</li><li>change avatar frequently (more than once a month).</li></ol>'
	),
	array(
		0 => '--',
