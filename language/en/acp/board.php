...
$lang = array_merge($lang, array(
	...
	'ENABLE_EMAIL_EXPLAIN'			=> 'If this is set to disabled, no e-mails will be sent by the board at all.<br /><em><strong>Warning:</strong> the user and admin account activation settings require this setting to be enabled.</em>',
