...
$lang = array_merge($lang, [
	...
	'CAPTCHA_GD_3D_NOISE'                   => 'Add noise objects',
	...
	'CAPTCHA_GD_FONTS_EXPLAIN'              => 'This setting controls how many different letter shapes are used.',
...
// Load Settings
$lang = array_merge($lang, [
	'ACP_LOAD_SETTINGS_EXPLAIN' => 'Here you can enable and disable certain board functions to reduce the amount of processing required. On most servers there is no need to disable any functions. However on certain systems or in shared hosting environments it may be beneficial to disable capabilities you do not really need. You can also limit active sessions, beyond which the board will go offline.',
	...
	'CACHE_MTIME_CHECK'             => 'Auto-refresh stale cached data',
	'CACHE_MTIME_CHECK_EXPLAIN'     => 'Check source file modification times and refresh stale cached/generated data automatically.',
...
$lang = array_merge($lang, [
	...
	'REFERER_VALID_EXPLAIN'         => 'If enabled, the referer of POST requests will be checked against the host.',
