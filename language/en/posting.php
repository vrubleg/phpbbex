...
$lang = array_merge($lang, array(
	...
	'BBCODE_L_HELP'				=> 'List: [list]items[/list] or [list=1]items[/list] (hold ctrl to enter a starting value for an ordered list)',
	'BBCODE_LISTITEM_HELP'		=> 'List item: [*] (select text to automatic insert in each line)',
	'BBCODE_P_HELP'				=> 'Insert image: [img]http://image_url[/img]',
	'BBCODE_Q_HELP'				=> 'Quote text: [quote]text[/quote] or [quote=&quot;name&quot;]text[/quote] (hold ctrl to enter a name)',
