...
$lang = array_merge($lang, array(
	'TERMS_OF_USE_CONTENT' => 'By accessing “%1$s” internet forum, you agree with the following terms. If you do not agree, please do not use this internet forum. We may change these terms, so it would be prudent to review this regularly yourself as your continued usage of this internet forum after changes mean you agree with updated terms.<br /><br />You agree not to post any abusive, obscene, vulgar, slanderous, hateful, threatening, sexually-orientated or any other material that may violate international laws. Doing so may lead to you being permanently banned. You agree that we have the right to remove, edit or move any public messages at any time should we see fit.',
	'PRIVACY_POLICY' => 'The “%1$s” internet forum uses cookies for keeping your session. Data that you submit is tied to your account and IP address. Your account will at a bare minimum contain a uniquely identifiable name, a personal password used for logging into your account and a personal e-mail address. Any information from your account, except password and e-mail address, will be publicly displayed. Your password is ciphered (a one-way hash) so that it is secure and impossible to restore even if the administrator would like to do it. But you can request a new password using the “I forgot my password” feature that sends a new randomly generated password to your e-mail. You have the option to opt-out of automatically generated e-mails from the internet forum, but e-mails that are required to reclaim access to your account may be sent anyway.',
));
