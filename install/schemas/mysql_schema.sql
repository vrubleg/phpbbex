...
CREATE TABLE phpbb_forums (
	...
	forum_topic_sortby_type varchar(1) DEFAULT 't' NOT NULL,
	forum_topic_sortby_dir varchar(1) DEFAULT 'd' NOT NULL,
	...
	forum_flags tinyint(4) DEFAULT '16' NOT NULL,
...
CREATE TABLE phpbb_login_attempts (
	...
	attempt_browser_ua varchar(250) DEFAULT '' NOT NULL,
...
CREATE TABLE phpbb_posts (
	...
	post_rating_negative mediumint(8) UNSIGNED NOT NULL DEFAULT 0,
...
CREATE TABLE phpbb_sessions (
	...
	session_bot_id mediumint(8) UNSIGNED DEFAULT '0' NOT NULL,
	...
	session_browser_ua varchar(250) DEFAULT '' NOT NULL,
	...
	KEY session_bot_id (session_bot_id)
) CHARACTER SET `utf8mb4` COLLATE `utf8mb4_bin`;
...
CREATE TABLE phpbb_users (
	...
	user_browser_ua varchar(250) DEFAULT '' NOT NULL,
	...
	user_password_pending varchar(40) DEFAULT '' NOT NULL,
	user_password_time int(11) UNSIGNED DEFAULT '0' NOT NULL,
	user_password_reset tinyint(1) UNSIGNED DEFAULT '0' NOT NULL,
	...
	user_rated_positive mediumint(8) UNSIGNED NOT NULL DEFAULT 0,
	user_rated_negative mediumint(8) UNSIGNED NOT NULL DEFAULT 0,
	...
	user_sig varchar(500) DEFAULT '' NOT NULL,
	user_sig_bbcode_uid varchar(8) DEFAULT '' NOT NULL,
	user_sig_bbcode_bitfield varchar(255) DEFAULT '' NOT NULL,
	user_from varchar(50) DEFAULT '' NOT NULL,
	user_icq varchar(15) DEFAULT '' NOT NULL,
	user_jabber varchar(100) DEFAULT '' NOT NULL,
	user_skype varchar(32) DEFAULT '' NOT NULL,
	user_telegram varchar(32) DEFAULT '' NOT NULL,
	user_website varchar(100) DEFAULT '' NOT NULL,
	user_occupation varchar(50) DEFAULT '' NOT NULL,
	user_about varchar(1000) DEFAULT '' NOT NULL,
